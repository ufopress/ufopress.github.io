window.addEventListener('DOMContentLoaded', event => {
    ...
    const actionButtons = document.querySelectorAll('#agregarBtn, #gestionarBtn, #modificarBtn, #sliderBtn, #agregarUserBtn, #gestionarAdminBtn, #gestionarClienteBtn, #regFormBtn, #agregarPromotionBtn, #gestionarClienteBtn, #gestionarSalesBtn, #inicioBtn');
